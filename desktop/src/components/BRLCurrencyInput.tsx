...
type BRLInputProps = Omit<React.InputHTMLAttributes<HTMLInputElement>, "onChange" | "value"> & {
  onChange: (valueInCents: number) => void;
  value?: number;
};

export default function BRLInput({ onChange, value = 0, ...props }: BRLInputProps) {
